...
A single-page dashboard summarizing residential tenant placement and leasing performance. Use the snapshot selector to swap between May–August 2024 datasets.
...
3. Use the **Snapshot** dropdown in the page header to preview all four monthly versions.

No build step is required—the dashboard is a static page.

## Data Highlights

- Placement pipeline metrics (applications, viewings, placements, no-shows) for each day in the selected month.
