...
- Tenant performance trends with full-year monthly coverage for rent collection and default rates, plus payment punctuality detail across all 31 days that mirrors typical residential patterns (28% paid on the 1st, 20% on the 2nd, tapering to <1% by month-end).
