...
- A month-over-month column of stat cards showing how rent collected and unpaid rent changed versus the prior month, including percentage shifts for each metric.
